  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-12  lg:h-[80vh] w-screen pb-44 items-center text-center bg-mainDark'>
        <h1 className='text-beidge pt-[40%] sm:pt-[20%] lg:pt-[10%] text-2xl sm:text-3xl lg:text-5xl font-bold font-Montserrat max-w-[70%] lg:max-w-[40%]'>
          Find any quote in millions of movie lines
        </h1>
        <Button
          text={t('home:start')}
          className='bg-red hover:bg-redHover font-normal px-10 py-3 text-[20px]'
        />
      </div>
