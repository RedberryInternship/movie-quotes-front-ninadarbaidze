...
const ErrorPopup = () => {
  ...
  return (
    <>
      <div className='flex flex-col px-2 pt-2 w-full absolute md:w-72 h-24 rounded bg-[#FEE2E2] top-0 right-0 z-50'>
        ...
        <p className='text-mainDark text-sm ml-3 mt-1 '>{userCtx.errorPopup}</p>
      </div>
    </>
  );
};
