...
import { useQuoteImageEditInput } from './useQuoteImageEditInput';

const QuoteImageEditInput: React.FC<FieldProps> = ({ form }) => {
  const { getRootProps, getInputProps, imageStateHandler, t, myLoader } =
    useQuoteImageEditInput({ form } as FieldProps);
...
export default QuoteImageEditInput;
